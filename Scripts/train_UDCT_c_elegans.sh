...
cd ../../../notebooks/
#jupyter nbconvert --to notebook --execute transform_c_elegans_tif_to_png.ipynb

# Create the raw dataset
echo "Creating the raw dataset"
jupyter nbconvert --to notebook --execute make_raw_c_elegans.ipynb

# Create the synthetic dataset
echo "Creating the synthetic dataset"
jupyter nbconvert --to notebook --execute make_synthetic_c_elegans.ipynb
